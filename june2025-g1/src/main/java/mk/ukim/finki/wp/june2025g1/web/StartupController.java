...
public class StartupController {
    ...
    public String showAdd(Model model) {
        model.addAttribute("startups", startupService.listAll());
        model.addAttribute("industries", Industry.values());
        model.addAttribute("founders", founderService.listAll());
        return "form";
    }
    ...
    public String create(@RequestParam String name,
                         ...
                         @RequestParam  Long founderId) throws Exception {
    ...
    public String deactivate(@PathVariable Long id) throws Exception {
