...
public class FieldFilterSpecification {
    ...
    public static <T, V extends Comparable<V>> Specification<T> filterGreaterThan(Class<T> clazz, String field, Double value) {
        if (value == null) {
            return null;
        }
        return (root, query, criteriaBuilder) -> criteriaBuilder.greaterThan(fieldToPath(field, (Root<Double>) root), value);
    }

    public static <T, V extends Comparable<V>> Specification<T> filterGreaterThan(Class<T> clazz, String field, Integer value) {
        if (value == null) {
            return null;
        }
        return (root, query, criteriaBuilder) -> criteriaBuilder.greaterThan(fieldToPath(field, (Root<Integer>) root), value);
    }
    ...
    public static <T> Specification<T> filterEquals(Class<T> clazz, String field, Industry value) {
        if (value == null) {
            return null;
        }
        return (root, query, criteriaBuilder) -> criteriaBuilder.equal(fieldToPath(field, root), value);
