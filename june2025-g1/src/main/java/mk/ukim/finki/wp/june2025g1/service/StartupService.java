...
public interface StartupService {
     ...
     */
    Startup findById(Long id) throws Exception;
     ...
     */
    Startup create(String name, Double valuation, Integer yearFounded, Industry industry, Long founderId) throws Exception;
     ...
     * @throws InvalidStartupIdException when there is no startup with the given id
     */
    Startup update(Long id, String name, Double valuation, Integer yearFounded, Industry industry, Long founderId) throws Exception;
     ...
     */
    Startup delete(Long id) throws Exception;
     ...
     */
    Startup deactivate(Long id) throws Exception;
