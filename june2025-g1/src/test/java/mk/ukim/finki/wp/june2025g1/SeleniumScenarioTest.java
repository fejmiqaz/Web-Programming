...
public class SeleniumScenarioTest {
    ...
    public void test_edit_mvc_10pt() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                ...
                .param("founderId", founders.getFirst().getId().toString());
        ...
        ExamAssert.assertEquals("The updated founder is not as expected.", founders.get(0).getId().toString(), startups.get(itemNum - 1).getFounder().getId().toString());
