...
public class FieldFilterSpecification {
    ...
    public static <T> Specification<T> filterEquals(Class<T> clazz, String field, Double value) {
        if (value == null) {
            return null;
        }
        return (root, query, criteriaBuilder) -> criteriaBuilder.equal(fieldToPath(field, root), value);
    ...
    public static <T> Specification<T> filterEquals(Class<T> clazz, String field, HistoricalPeriod value) {
        if (value == null) {
            return null;
        }
        return (root, query, criteriaBuilder) -> criteriaBuilder.equal(fieldToPath(field, root), value);
