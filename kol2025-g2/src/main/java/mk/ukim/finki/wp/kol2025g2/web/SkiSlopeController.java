...
public class SkiSlopeController {
    ...
    private final SkiResortService skiSResortService;
    ...
    public String listAll(@RequestParam(required = false) String name,
        ...
        Page<SkiSlope> skiSlopePage = skiSlopeService.findPage(name, length, difficulty, skiResort, pageNum-1, pageSize);
        model.addAttribute("page", skiSlopePage);
        ...
        model.addAttribute("skiResorts", this.skiSResortService.listAll());
    ...
    public String showAdd(Model model) {
        ...
        model.addAttribute("skiResort", skiSResortService.listAll());
        return "form";
    }
    ...
    public String create(@RequestParam String name,
                         ...
                         @RequestParam Long skiResort) throws Exception {
