...
public interface SkiSlopeService {
     ...
     */
    SkiSlope findById(Long id) throws Exception;
     ...
     */
    SkiSlope create(String name, Integer length, SlopeDifficulty difficulty, Long skiResort) throws Exception;
     ...
     * @throws InvalidSkiSlopeIdException when there is no ski slope with the given id
     */
    SkiSlope update(Long id, String name, Integer length, SlopeDifficulty difficulty, Long skiResort) throws Exception;
